<script>
  ...
  import FiArrowDown from "svelte-icons-pack/fi/FiArrowDown";
...
>
  ...
  <a href="#SkillSection"
    ...
    ><Icon
      ...
      className="text-6xl h-fit w-fit group-hover:scale-150 transition-all duration-300 button-bounce"
